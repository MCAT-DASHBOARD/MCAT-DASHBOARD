    ...
    for attempt in range(retries + 1):
        try:
            ...
            if len(prices) < 70:
                ...
                return {"value": None, "dpo_1w": None, "dpo_2w": None, "hurst": None, "in_buy_zone": False, "error": f"insufficient data ({len(prices)} points)"}
            ...
            if dpo_val is None:
                ...
                return {"value": None, "dpo_1w": None, "dpo_2w": None, "hurst": None, "in_buy_zone": False, "error": "DPO computation failed"}
            ...
            return {"value": None, "dpo_1w": None, "dpo_2w": None, "hurst": None, "in_buy_zone": False, "error": str(e)}
...
def update_exit_level(asset_state, dpo20_today, dpo40_today, symbol):
    ...
    # 120-day timeout for signals that never reached OVERHEATED
    if asset_state.get('signal_active') and asset_state.get('signal_days_ago', 0) >= 120:
        if not asset_state.get('was_overheated'):
            asset_state['exit_level'] = 'STALE_SIGNAL'
            return asset_state
...
def run_pipeline(local_mode=False):
    ...
    try:
        ...
        btc_dpo = {"value": btc_dpo_val, "dpo_1w": btc_dpo_1w, "dpo_2w": btc_dpo_2w, "hurst": btc_hurst, "in_buy_zone": btc_dpo_val is not None and btc_dpo_val < 20}
        ...
        btc_dpo = {"value": None, "dpo_1w": None, "dpo_2w": None, "hurst": None, "in_buy_zone": False, "error": str(e)}
